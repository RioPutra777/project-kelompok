...
export default function MakananMinumanPage() {
  // Contoh data produk makanan & minuman kelompok
  const daftarStokFood = [
    { id: 1, nama: "Susu UHT Full Cream", stok: 120, status: "Aman", tglExpired: "15-10-2026", warnaStatus: "text-emerald-600 bg-emerald-50" },
    { id: 2, nama: "Roti Gandum Kupas", stok: 4, status: "Hampir Habis", tglExpired: "25-06-2026", warnaStatus: "text-amber-600 bg-amber-50" },
    { id: 3, nama: "Yogurt Blueberry", stok: 15, status: "CRITICAL EXP", tglExpired: "22-06-2026", warnaStatus: "text-rose-600 bg-rose-50" },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 font-sans">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm p-6 border border-slate-200">
        ...
        {/* JUDUL HALAMAN */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-slate-800">Dashboard Manajemen Makanan & Minuman</h1>
          <p className="text-slate-500 text-sm mt-1">Sistem Pemantauan Stok Kuliner, Barcode, dan Expired Alert Kelompok</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl p-5 text-white mb-8 shadow-sm">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="font-bold text-base">Simulasi Sistem Scan Barcode Makanan</h3>
              <p className="text-orange-100 text-xs mt-0.5">Klik tombol untuk mensimulasikan alat scan barcode produk konsumsi.</p>
            </div>
        ...
        <div>
          <h3 className="font-bold text-slate-700 text-sm mb-4 flex items-center gap-2">
            📋 Daftar Stok Real-Time & Notifikasi Kedaluwarsa Makanan
          </h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-slate-600 text-xs font-bold">
                  <th className="p-3">Nama Produk Kuliner</th>
